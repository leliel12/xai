...
**Experimento 2 — Faithfulness:** Se aplica input perturbation utilizando marginalización con
background set (KernelSHAP): si se marginaliza la feature más importante según SHAP, ¿la
predicción cambia más que si se marginaliza una feature aleatoria? Se computa un faithfulness
score por instancia siguiendo la metodología de Covert et al. (2021).
...
| **Semana 2** | Cómputo de SHAP values globales y locales; implementación de Experimento 1 (estabilidad: varianza del ranking top-k entre seeds y tamaños de background); implementación de Experimento 2 (faithfulness via marginalización con background set, siguiendo KernelSHAP) |
